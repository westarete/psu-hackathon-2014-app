...
Gem::Specification.new do |s|
  s.name = %q{sinatra-contrib}
  s.version = "1.4.2"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Konstantin Haase", "Gabriel Andretta", "Trevor Bramble", "Zachary Scott", "Katrina Owen", "Nicolas Sanguinetti", "Hrvoje \305\240imi\304\207", "Masahiro Fujiwara", "Rafael Magana", "Jack Chu", "Ilya Shindyapin", "Kashyap", "Sumeet Singh", "lest", "Adrian Paca\305\202a", "Aish", "Andrew Crump", "David Asabina", "Eliot Shepard", "Eric Marden", "Gray Manley", "Guillaume Bouteille", "Jamie Hodge", "Kyle Lacy", "Martin Frost", "Mathieu Allaire", "Matt Lyon", "Matthew Conway", "Meck", "Michi Huber", "Patricio Mac Adden", "Reed Lipman", "Samy Dindane", "Thibaut Sacreste", "Uchio KONDO", "Will Bailey", "undr"]
  s.date = %q{2013-12-01}
  s.description = %q{Collection of useful Sinatra extensions}
  ...
  s.homepage = %q{http://github.com/sinatra/sinatra-contrib}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.6.2}
  s.summary = %q{Collection of useful Sinatra extensions}
